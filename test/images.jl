...
@testset "ReadWriteImage" begin
    img = load_ehtimfits("../example/data/elliptical_gaussian_rot-45.00m87Scale_seed_23_simobs_netcal_scanavg-z0.6-s100-t1-v100-l10-p40-e0.000.fits")
...
@testset "ImageModifiers" begin
    img = VIDA.load_ehtimfits("../example/data/elliptical_gaussian_rot-45.00m87Scale_seed_23_simobs_netcal_scanavg-z0.6-s100-t1-v100-l10-p40-e0.000.fits")
